...
--   raw_tov — сырьё, три ключа: common, direct, reverse;
...
--
-- Доп. джадж по речевым в этот выход отдельным блоком не едет: его добор уже
-- сидит внутри markers_A / markers_B в out_tov, а сырой ответ джаджа лежит в
-- выходе 1 (speech_check_1/2) и в agg_tov_markup выхода 2.
--
