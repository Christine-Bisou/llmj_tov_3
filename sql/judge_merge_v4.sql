...
-- Если обратный прогон тоже начнёт класть второй этап в dst_2 — поменяй на i2.dst_2.
--
...
SELECT
    ...
    -- ---------- вердикт ----------
    -- сорсы во входной таблице зовутся answer_source_1 / answer_source_2;
    -- source_A / source_B — это уже имена полей формата разметки, не колонки
    Just(Yson::From(<|
