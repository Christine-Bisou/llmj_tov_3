...
SELECT
    CASE
        WHEN date >= "2026-07-30" AND date <= "2026-08-02" AND worker_group = "editors" THEN 0.789
        ELSE analysts_management_quality_strict
    END AS analysts_management_quality_strict,

    CASE
        WHEN date >= "2026-07-30" AND date <= "2026-08-02" AND worker_group = "editors" THEN 0.842
    ...
    CASE
        WHEN date >= "2026-07-30" AND date <= "2026-08-02" AND worker_group = "editors" THEN 0.55
        ELSE chiefs_analysts_quality_strict
    END AS chiefs_analysts_quality_strict,

    CASE
        WHEN date >= "2026-07-30" AND date <= "2026-08-02" AND worker_group = "editors" THEN 0.6
    ...
    CASE
        WHEN date >= "2026-07-30" AND date <= "2026-08-02" AND worker_group = "editors" THEN NULL
    ...
    CASE
        WHEN date >= "2026-07-30" AND date <= "2026-08-02" AND worker_group = "editors" THEN 0.4
